...
invariants in :mod:`askpanda_epic._traceback_parse`; when one is found the
...
from askpanda_epic._traceback_parse import (
    ExceptionInfo,
    TracebackBlock,
    coerce_bool,
    coerce_int,
...
def _classify_from_exception(exception: ExceptionInfo) -> str | None:
    ...
    Args:
        exception: Parsed exception from :mod:`askpanda_epic._traceback_parse`.
